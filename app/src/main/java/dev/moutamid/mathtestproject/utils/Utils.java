package dev.moutamid.mathtestproject.utils;
...
public class Utils {
    ...
    //    getObject
    public static UserModel getObject(String key, Class<?> tClass) {
//    public static <T> Object getObject(String key, Class<?> tClass) {
//          implementation 'com.google.code.gson:gson:2.8.7'
        checkfornull();
        try {
            Gson gson = new GsonBuilder().create();
            return gson.fromJson(utils.sp.getString(key, ""), UserModel.class);
...
//          implementation 'com.google.code.gson:gson:2.8.7'
        ...
        Log.d("HELP", "getArrayList: data: " + data);
